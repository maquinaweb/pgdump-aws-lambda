...
describe('Handler', () => {
    ...
    it('should upload a backup', async () => {
        ...
        expect(key).to.equal('2017-05-02/dbname/dbname-02-05-2017_01-33-11.backup')
        expect(result).to.equal(
            'mock-uploaded/2017-05-02/dbname/dbname-02-05-2017_01-33-11.backup'
        )
    })
    ...
    it('should support multiple database names', async () => {
        ...
        expect(s3Spy.calledTwice).to.be.true
        {
            ...
            expect(key).to.equal('2017-05-02/dbone/dbone-02-05-2017_01-33-11.backup')
        }
        {
            // second call
            ...
            expect(key).to.equal('2017-05-02/dbtwo/dbtwo-02-05-2017_01-33-11.backup')
        }

        // result should be an array with two backup paths
        expect(result).deep.to.equal([
            'mock-uploaded/2017-05-02/dbone/dbone-02-05-2017_01-33-11.backup',
            'mock-uploaded/2017-05-02/dbtwo/dbtwo-02-05-2017_01-33-11.backup'
        ])
    })
    ...
    it('should upload the backup file and an iv file', async () => {
        ...
        expect(key).to.equal('2017-05-02/dbname/dbname-02-05-2017_01-33-11.backup.iv')
        ...
        expect(key2).to.equal('2017-05-02/dbname/dbname-02-05-2017_01-33-11.backup')
